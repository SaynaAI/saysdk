 ...
 * Returns all rooms belonging to the authenticated tenant.
 */
...
export interface RemoveLiveKitParticipantRequest {
  /** The LiveKit room name where the participant is connected (without tenant prefix) */
  room_name: string;
...
export interface SipTransferRequest {
  /** The LiveKit room name where the SIP participant is connected (without tenant prefix) */
  room_name: string;
